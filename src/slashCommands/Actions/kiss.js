...
module.exports.commandLogic = async itemsToImport => {
    ...
    if (mentionedUserID === message.author.id) return interaction.createMessage({"flags":64, "content": "You cant kiss yourself."}).catch(err => console.error("Cannot send messages to this channel", err));
