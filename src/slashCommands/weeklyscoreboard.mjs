...
export const commandLogic = async itemsToImport => {
    ...
    const table = await query("db", {text: 'SELECT * FROM weeklylb WHERE serverid = $1 order by bumps desc fetch first 10 rows only', values: [interaction.channel.guild.id]});
