...
module.exports =  async function handleMessage (sharder, message) {
    ...
    message.channel.createMessage({"embeds":[{"description": `It looks like that is a valid command but I have switched to slash commands. Try running /${command}. If none of my commands show up you may need to re-invite me using [this invite](https://discord.com/oauth2/authorize?client_id=763088956454994000&scope=applications.commands)`}]})  
}