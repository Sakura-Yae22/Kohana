module.exports = {
    "commandLogic": async function commandLogic({message, sharder} = itemsToImport) {
        ...
        message.channel.createMessage({"embeds": {"title": `User stats`,"description": `Total bumps: **${totalBumps[0].sum}**`, "color": 5747894}}).catch(err => console.error("Cannot send messages to this channel", err));
    },
    "help":[
