module.exports = {
    "commandLogic": async function commandLogic({sharder, message} = itemsToImport) {
        ...
        message.channel.createMessage(embeds).catch(err => console.error("Cannot send messages to this channel", err));        
    },
    "help":[
